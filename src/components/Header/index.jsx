  ...
  return (
    <div className="w-full flex items-center justify-between bg-white/75 backdrop-blur-sm rounded-[15px] p-[20px]">
      <div className="flex items-center gap-[20px]">
        <div className="bg-[#F2F2F2] px-[15px] py-[6px] rounded-[25px] flex items-center justify-center border border-primary">
          <UserCard name="ABC xyz" image="./asset/logo/logo.png" />
        </div>
      ...
      <div className="flex items-center gap-[20px]">
        <div className="flex items-center gap-[10px] px-[13px] py-[8px] rounded-[25px] hover:bg-[#E2E2E2] cursor-pointer ">
          <img
        ...
        <div className="relative w-[40px] h-[40px] rounded-full bg-[#F2F2F2] flex items-center justify-center ">
